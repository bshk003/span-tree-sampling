...
from rendering.grid_2d import GridRenderer


# Grid dimensions.
rows, cols = 30, 30
renderer = GridRenderer(rows, cols)
...
# delta[<degree>] : node degrees contribution (<degree> in 0,1,...4)
...
tree = GridSpanningTree(rows, cols, params=params_spr, initial=None)

# Smaller beta (higher temperature) -- more random fluctuations.
# Larger beta promotes convergence to metastable states.
sampler = MetropolisHastings(tree, beta=0.1)

# Saving rendered frames as animation.
